...
class Handler(BaseHandler):
    ...
    @every(minutes=24 * 60)
    def on_start(self):
        self.crawl('http://ganma.papayamobile.com/discovery/beijing/%E6%9C%80%E8%BF%91%E4%B8%80%E6%9C%88/%E7%BE%8E%E9%A3%9F/', callback=self.index_page, force_update=True)
