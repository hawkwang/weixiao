...
class Handler(BaseHandler):
    ...
    targetpattern = r'http://www.meetup.com/Beijing-Kubernetes-Meetup/events/\d+/'
        
    @every(minutes=24 * 60)
    def on_start(self):
        self.crawl('http://www.meetup.com/Beijing-Kubernetes-Meetup/', callback=self.index_page, force_update=True)
    ...
    def detail_page(self, response):
         ...
         datetime1 = response.doc('time').attr.datetime
         print datetime1
