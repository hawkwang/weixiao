...
def getUrls():
    urls = []
    baseUrl = 'http://xjh.haitou.cc/bj/uni-0/after/hold/page-'
...
class EventSpider(CrawlSpider):
    name = "event"
    allowed_domains = ["http://xjh.haitou.cc"]
    start_urls = getUrls()

    attributes={}
    
    rules = ()
    targetpattern = r'http://xjh.haitou.cc/article/\d+.html'
