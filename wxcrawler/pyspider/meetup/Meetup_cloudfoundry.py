...
class Handler(BaseHandler):
    ...
    targetpattern = r'http://www.meetup.com/Beijing-PaaS-Bluemix-and-Cloud-Computing-Meetup/events/\d+/'
        
    @every(minutes=24 * 60)
    def on_start(self):
        self.crawl('http://www.meetup.com/Beijing-PaaS-Bluemix-and-Cloud-Computing-Meetup/', callback=self.index_page, force_update=True)
    ...
    def detail_page(self, response):
         ...
         result = {
             ...
             "source": '33',
             "city": 'beijing',
             "category": u'IT-云计算-CloudFoundry',
             "title": title,
             "link": link,
             "date": date,
             "time": time,
