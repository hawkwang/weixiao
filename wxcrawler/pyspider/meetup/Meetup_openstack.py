...
class Handler(BaseHandler):
    ...
    targetpattern = r'http://www.meetup.com/China-OpenStack-User-Group/events/\d+/'
        
    @every(minutes=24 * 60)
    def on_start(self):
        self.crawl('http://www.meetup.com/China-OpenStack-User-Group/', callback=self.index_page, force_update=True)
