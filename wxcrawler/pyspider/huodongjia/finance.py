...
class Handler(BaseHandler):
    ...
    def on_start(self):
        ...
        for page in pages:
            try:
                time.sleep(5)
                url = 'http://m.huodongjia.com/list_ajax/beijing/finance/?page=' + str(page)
        ...
        #self.crawl('http://m.huodongjia.com/list_ajax/beijing/it/?page=1&_=1431579513747', callback=self.index_page)
